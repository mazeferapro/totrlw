...
AddItem("arc9_k_launcher_rps6_republic", "Arc9 K Launcher Rps6 Republic (No File)", "arc9_k_launcher_rps6_republic", "heavy", 5, 2, 250, "models/weapons/w_rif_ak47.mdl", "icon16/gun.png")
...
AddItem("arccw_cgi_k_rps6", "RPS-6", "arccw_cgi_k_rps6", "heavy", 5, 2, 250, "models/kraken/cgi/world/w_cgi_rps6.mdl", "entities/arccw/kraken/cgi/rps6.png")
...
AddItem("arccw_k_launcher_e60r", "E-60r", "arccw_k_launcher_e60r", "heavy", 5, 2, 250, "models/arccw/kraken/w_e11.mdl", "entities/kraken/explosives/e60r.png")
AddItem("arccw_k_launcher_hh12", "Republic HH-12", "arccw_k_launcher_hh12", "heavy", 5, 2, 250, "models/arccw/kraken/w_e11.mdl", "entities/kraken/explosives/hh12.png")
AddItem("arccw_k_launcher_hh12_empire", "Empire HH-12", "arccw_k_launcher_hh12_empire", "heavy", 5, 2, 250, "models/arccw/kraken/w_e11.mdl", "entities/kraken/explosives/hh12_imperio.png")
AddItem("arccw_k_launcher_plx1", "Republic PLX-1", "arccw_k_launcher_plx1", "heavy", 5, 2, 250, "models/arccw/kraken/w_e11.mdl", "entities/kraken/explosives/plx1.png")
AddItem("arccw_k_launcher_plx1_empire", "Empire PLX-1", "arccw_k_launcher_plx1_empire", "heavy", 5, 2, 250, "models/arccw/kraken/w_e11.mdl", "entities/kraken/explosives/plx1_imperio.png")
AddItem("arccw_k_launcher_rps6", "Republic RPS-6", "arccw_k_launcher_rps6", "heavy", 5, 2, 250, "models/arccw/kraken/w_e11.mdl", "entities/kraken/explosives/rps6.png")
AddItem("arccw_k_launcher_rps6_empire", "Empire RPS-6", "arccw_k_launcher_rps6_empire", "heavy", 5, 2, 250, "models/arccw/kraken/w_e11.mdl", "entities/kraken/explosives/rps6_imperio.png")
AddItem("arccw_k_launcher_smartlauncher", "Smart Launcher", "arccw_k_launcher_smartlauncher", "heavy", 5, 2, 250, "models/arccw/kraken/w_e11.mdl", "entities/kraken/explosives/smartlauncher.png")
...
AddItem("arccw_sops_republic_z6x", "ZX-6", "arccw_sops_republic_z6x", "heavy", 5, 2, 250, "models/arccw/kraken/sops/world/w_zx6.mdl", "entities/kraken/sops/z6x.png")
AddItem("arccw_sops_vibroknife", "Vibroknife", "arccw_sops_vibroknife", "secondary", 1, 1, 30, "models/arccw/kraken/sops/world/w_vibroknife.mdl", "entities/kraken/sops/vibroknife.png")
...
AddItem("weapon_bactainjector", "Bactainjector (No File)", "weapon_bactainjector", "medical", 1, 1, 30, "models/weapons/w_rif_ak47.mdl", "icon16/gun.png")
...
AddItem("weapon_defibrillator", "Defibrillator (No File)", "weapon_defibrillator", "medical", 4, 2, 100, "models/weapons/w_rif_ak47.mdl", "icon16/gun.png")
AddItem("weapon_lvsrepair", "Lvsrepair (No File)", "weapon_lvsrepair", "special", 4, 2, 100, "models/weapons/w_rif_ak47.mdl", "icon16/gun.png")
AddItem("weapon_marker", "Marker (No File)", "weapon_marker", "special", 4, 2, 100, "models/weapons/w_rif_ak47.mdl", "icon16/gun.png")
...
AddItem("weapon_officerboost_laststand", "Officerboost Laststand (No File)", "weapon_officerboost_laststand", "special", 4, 2, 100, "models/weapons/w_rif_ak47.mdl", "icon16/gun.png")
AddItem("weapon_officerboost_normal", "Officerboost Normal (No File)", "weapon_officerboost_normal", "special", 4, 2, 100, "models/weapons/w_rif_ak47.mdl", "icon16/gun.png")
...
AddItem("weapon_stunstick", "Stunstick (No File)", "weapon_stunstick", "special", 4, 2, 100, "models/weapons/w_rif_ak47.mdl", "icon16/gun.png")
AddItem("weapon_vibrosword", "Vibrosword (No File)", "weapon_vibrosword", "secondary", 4, 2, 100, "models/weapons/w_rif_ak47.mdl", "icon16/gun.png")
